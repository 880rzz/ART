...
if (/mozgóképen és nyilvános\./i.test(hu)) failures.push('hu/index.html: truncated Hungarian meta description survived');
if (!hu.includes('fotográfiák, könyvek, kiállítások, filmek és a hozzájuk kapcsolódó történetek.')) failures.push('hu/index.html: corrected Hungarian archive description missing');
