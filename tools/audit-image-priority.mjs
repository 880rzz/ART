...
walk('.');
if(failures.length){console.error('ART image priority audit FAILED:\n'+failures.map(x=>' - '+x).join('\n'));process.exit(1)}
console.log('ART image priority audit passed: no competing high-priority or preload image requests.');
