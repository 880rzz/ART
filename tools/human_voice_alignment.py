...
PAGES = {
    'index.html': {
        ...
        'education': 'Education',
        'verified': 'Verified biography — Wikipedia',
        'community': 'Community & teaching',
        'writing': 'Writing & ambassadorship',
        'press': 'Press',
        'curators': 'For curators: the full dossier',
        'hero_label': 'The investigation of presence · Since 1999',
        'hero_sub': 'Fine art photography between Vienna and Budapest',
        'menu_about': 'About me',
        'menu_about_desc': 'Where the work comes from, and why the investigation of presence has remained at its centre since 1999.',
        'footer_role': 'Fine Art Photographer',
    },
    'hu/index.html': {
        'label': 'Rólam',
        'heading': 'A saját szavaimmal',
        ...
        'recognition': 'Elismerések',
        'education': 'Tanulmányok',
        'verified': 'Ellenőrzött életrajz — Wikipédia',
        'community': 'Közösség és oktatás',
        'writing': 'Írások és márkanagyköveti munka',
        'press': 'Sajtó',
        'curators': 'Kurátoroknak: teljes dosszié',
        'hero_label': 'A jelenlét kutatása · 1999 óta',
        'hero_sub': 'Fotóművészet Bécs és Budapest között',
        'menu_about': 'Rólam',
        'menu_about_desc': 'Honnan ered a munka, és miért maradt 1999 óta a jelenlét kutatása a középpontjában.',
        'footer_role': 'Fotóművész',
    },
    'de-at/index.html': {
        'label': 'Über mich',
        'heading': 'In meinen eigenen Worten',
        ...
        'verified': 'Verifizierte Biografie — Wikipedia',
        'community': 'Gemeinschaft & Vermittlung',
        'writing': 'Texte & Markenbotschafterarbeit',
        'press': 'Presse',
        'curators': 'Für Kurator:innen: vollständiges Dossier',
        'hero_label': 'Die Erforschung der Präsenz · Seit 1999',
        'hero_sub': 'Künstlerische Fotografie zwischen Wien und Budapest',
        'menu_about': 'Über mich',
        'menu_about_desc': 'Woher die Arbeit kommt und warum die Erforschung der Präsenz seit 1999 in ihrem Zentrum steht.',
        'footer_role': 'Fotokünstler',
    },
}


def links_for(rel):
    if rel.startswith('hu/'):
        return ('community.html','writing.html','press.html','curators.html')
    if rel.startswith('de-at/'):
        return ('community.html','writing.html','press.html','curators.html')
    return ('community.html','writing.html','press.html','curators.html')
...
def about_section(rel, c):
    ...
    return f'''<section id="about" class="tone-b"><div class="wrap bio-grid">
  <div>
    <div class="portrait-circle"><img src="/assets/img/portrait-circle.png" width="900" height="900" alt="Norbert Bánhalmi" loading="lazy" decoding="async"></div>
    <p class="meta" style="text-align:center">Norbert Bánhalmi<br>* 14.05.1979, Budapest<br>Wien / Budapest</p>
  </div>
  <div>
    <p class="label">{c['label']}</p><h2>{c['heading']}</h2>
    <p class="lead" style="font-size:1.0625rem">{c['lead']}</p>
    {paragraphs}
    <div class="facts">
      <div><h4>{c['recognition']}</h4><ul><li>Turul Award — 2021, 2022, 2023, 2024, 2025</li><li>TOP100 of Hungary — 2022</li><li>OM SYSTEM Ambassador since 2018</li></ul></div>
      <div><h4>{c['education']}</h4><ul><li>New York Institute of Photography — 2015</li><li>Applied photographer qualification — 2018</li><li>BEng Information Engineering — 2005</li></ul></div>
    </div>
    <p class="meta" style="margin-top:1.8rem">
      <a href="https://hu.wikipedia.org/wiki/B%C3%A1nhalmi_Norbert" target="_blank" rel="noopener">{c['verified']}</a><br>
      <a href="{community}">{c['community']} →</a> ·
      <a href="{writing}">{c['writing']} →</a> ·
      <a href="{press}">{c['press']} →</a> ·
      <a href="{curators}">{c['curators']} →</a></p>
  </div>
</div></section>'''
...
for rel, c in PAGES.items():
    ...
    # Keep the hero and menu in the same restrained, first-person, presence-led voice.
