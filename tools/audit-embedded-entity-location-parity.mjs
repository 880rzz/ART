...
console.log(`ART embedded entity location parity passed across ${pages} pages; Person ${personObjects}, Organization ${orgObjects}; business locations use workLocation only.`);
