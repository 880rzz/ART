...
PAGES = {
    'curators.html': {
        ...
        'intro':'The archive is organised around a single long-term inquiry rather than around isolated books, exhibitions or commissions. The MOL Project is the point of departure. From there, each period changes the social setting, the bodies and the public context, while the central question remains the same: when does a person, a memory or a community become genuinely present?',
        'items':[
            ('I','MOL Project — point of departure','The first coherent field of inquiry: discipline, role, institutional identity and the tension between appearance and truth.'),
    ...
    'hu/curators.html': {
        ...
        'intro':'Az archívumot nem különálló könyvek, kiállítások vagy megbízások szerint rendezi a rendszer, hanem egy hosszú távú kutatás mentén. A kiindulópont a MOL Project. Innen haladva változik a társadalmi közeg, a test, az emlékezet és a nyilvánosság szerepe, miközben a központi kérdés ugyanaz marad: mikor válik egy ember, egy emlék vagy egy közösség valóban jelenlévővé?',
        'items':[
            ('I','MOL Project — a kiindulópont','Az első következetes kutatási tér: fegyelem, szerep, intézményi identitás, valamint a megjelenés és az igazság közötti feszültség.'),
    ...
    'de-at/curators.html': {
        ...
        'intro':'Das Archiv ist nicht nach voneinander getrennten Büchern, Ausstellungen oder Aufträgen geordnet, sondern entlang einer langfristigen Untersuchung. Ausgangspunkt ist das MOL Project. Von dort verändern sich gesellschaftlicher Raum, Körper, Erinnerung und Öffentlichkeit, während die zentrale Frage bestehen bleibt: Wann wird ein Mensch, eine Erinnerung oder eine Gemeinschaft wirklich gegenwärtig?',
        'items':[
            ('I','MOL Project — der Ausgangspunkt','Das erste konsequente Forschungsfeld: Disziplin, Rolle, institutionelle Identität und die Spannung zwischen Erscheinung und Wahrheit.'),
