...
// Keep nested/runtime stylesheet dependencies on the same immutable release.
...
runtime=runtime.replace(/archive-content-flow\.css\?v=[^'"\s]+/g,`archive-content-flow.css?v=${release}`);
runtime=runtime.replace(/record-editorial-system\.css\?v=[^'"\s]+/g,`record-editorial-system.css?v=${release}`);
