...
def press_main(old,code):
 ...
 sources=[('Wikipedia','https://hu.wikipedia.org/wiki/B%C3%A1nhalmi_Norbert'),('Wikidata','https://www.wikidata.org/wiki/Q56391118'),('Wikimedia Commons','https://commons.wikimedia.org/wiki/Category:Norbert_Banhalmi'),('YouTube','https://www.youtube.com/@norbert.banhalmi/playlists')]
