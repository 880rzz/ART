...
const types = new Map([
  ...
  ['.txt','text/plain; charset=utf-8'],['.svg','image/svg+xml'],['.webp','image/webp'],['.jpg','image/jpeg'],['.jpeg','image/jpeg'],
  ['.png','image/png'],['.gif','image/gif'],['.ico','image/x-icon'],['.mp4','video/mp4'],['.woff2','font/woff2']
]);
