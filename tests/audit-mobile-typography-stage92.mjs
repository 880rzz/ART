...
const errors=[];
const releaseConfig=JSON.parse(fs.readFileSync('data/design-release.json','utf8'));
...
console.log('Stage 92 mobile typography audit passed on '+RELEASE+': '+content+' ART content pages inherit a final 14px minimum semantic reading floor on phones; inline sub-14px !important text is forbidden.');
