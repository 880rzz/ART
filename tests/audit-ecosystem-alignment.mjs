...
assert(bridgeOrganization?.name === 'BANHALMI' && bridgeOrganization?.legalName === 'Banhalmi Norbert e.U.', 'ecosystem-bridge.jsonld: Organization brand/legalName must match canonical professional graph');
