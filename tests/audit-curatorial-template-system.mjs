...
// It protects the reference-page parity and the single footer boundary together.
...
console.log('Curatorial template audit passed: shared hero, homepage chapters and single footer boundary are guarded across 15 pages.');
