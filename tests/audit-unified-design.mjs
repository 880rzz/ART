...
for(const token of ['height:100dvh','overflow:hidden','body.apple-archive.menu-open','grid-template-columns:repeat(3,minmax(0,1fr))','@media (max-width:900px)','@media (max-width:560px)','--art-line:1.62','main>section+section'])if(!css.includes(token))failures.push(`archive-system.css: missing ${token}`);
