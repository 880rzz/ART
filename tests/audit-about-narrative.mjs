...
const checks = [
  ...
  ['Hungarian domain continued', partial.includes('banhalminorbert.hu') && partial.includes('magyar nyelvű rész szerepét vitte tovább')],
  ...
  ['two primary domains', partial.includes('két fő domainre épül') && partial.includes('norbertbanhalmi.com') && partial.includes('banhalmi.art')],
  ['all four domains active', partial.includes('mind a négy domain él')],
  ['language entry points', partial.includes('magyar, illetve a német nyelvű belépési pontot biztosítja')],
