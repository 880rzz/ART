(() => {
  ...
  if (!document.querySelector('link[data-art-chronology-surface-authority]')) {
    ...
    chronologySurfaceAuthority.href = '/assets/css/chronology-surface-authority.css?v=20260811-rendered-contrast-v114';
  ...
  if (!document.querySelector('link[data-art-content-flow]')) {
    ...
    contentFlow.href = '/assets/css/archive-content-flow.css?v=20260811-rendered-contrast-v114';
  ...
  if ((isExhibitionRecord || isBookRecord) && !document.querySelector('link[data-art-record-editorial]')) {
    ...
    recordEditorial.href = '/assets/css/record-editorial-system.css?v=20260811-rendered-contrast-v114';
