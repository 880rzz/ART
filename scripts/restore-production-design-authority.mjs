...
for(const newHref of bundleRenames.values()){
  ...
  if(!css.includes(`max-width:${design.desktop.sourceHubStructuredMaxPx}px!important`)) throw new Error(`ART source-hub structured canvas authority missing from ${newHref}`);
}
