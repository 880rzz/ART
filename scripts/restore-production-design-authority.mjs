...
const runtimeTypographyClosure = `<style data-art-runtime-typography-closure="v1">/* ${runtimeTypographyMarker} */html body.apple-archive main#main-content :is(p,li){line-height:1.68!important}html body.apple-archive main#main-content :is(p.hero-sub,p.presence-copy){line-height:1.68!important}html body.apple-archive[data-archive-page="index"] main#main-content p.meta{font-size:16px!important;line-height:1.6!important}@media(min-width:769px) and (max-width:1100px){html body.apple-archive[data-archive-page="curators"] main#main-content details[open]{grid-column:1/-1!important;justify-self:stretch!important;width:100%!important;max-width:none!important}html body.apple-archive[data-archive-page="curators"] main#main-content :is(section,article,div,ul,ol):has(details[open]){grid-template-columns:minmax(0,1fr)!important}html body.apple-archive[data-archive-page="curators"] main#main-content details[open] :is(p,li,a,small,span,strong){max-width:none!important;width:auto!important}}@media(min-width:700px) and (max-width:900px){html body.apple-archive.press-page main#main-content details[open]{grid-column:1/-1!important;justify-self:stretch!important;width:100%!important;max-width:none!important}html body.apple-archive.press-page main#main-content :is(section,article,div,ul,ol):has(details[open]){grid-template-columns:minmax(0,1fr)!important}html body.apple-archive.press-page main#main-content details[open] :is(p,li,a,small,span,strong){max-width:none!important;width:auto!important}}</style>`;
