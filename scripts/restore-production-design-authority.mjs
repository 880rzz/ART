...
const protectedFiles = {
  ...
  'professional-llm-mirror.json': [
    'Q138482177','hipstudioFounderAuthority',
    "Bánhalmi Norbert and Speier Vikó are HIPStudio's main professional photographer partners",
    'Speier Vikó is the photography-services contact','1111 Budapest, Lágymányosi utca 15.',
...
for(const newHref of bundleRenames.values()){
  ...
  for(const required of [
    'ART-MACHINE-DESIGN-AUTHORITY',design.palette.panel,
